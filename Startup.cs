...
namespace TransactionLibrary.API
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .ConfigureApiBehaviorOptions(setupAction =>
            {
                setupAction.InvalidModelStateResponseFactory = context =>
                {
                    ...
                    {
                        problemDetails.Type = "https://TransactionLibrary.com/modelvalidationproblem";
            ...
            services.AddScoped<ITransactionLibraryRepository, TransactionLibraryRepository>();
